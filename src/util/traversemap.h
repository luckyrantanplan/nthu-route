...
template<class T>
inline const T& EdgeColorMap<T>::color(int x, int y, /*int z,*/DirectionType dir) const {
    return edgePlane.edge(x, y, /*z,*/dir);
}

template<class T>
inline const T& EdgeColorMap<T>::color(Coordinate& coor, DirectionType dir) const {
    return edgePlane.edge(coor.x(), coor.y(), /*coor.z(),*/dir);
}

template<class T>
inline T& EdgeColorMap<T>::color(int x, int y, /*int z,*/DirectionType dir) {
    return edgePlane.edge(x, y, /*z,*/dir);
}

template<class T>
inline T& EdgeColorMap<T>::color(Coordinate& coor, DirectionType dir) {
    return edgePlane.edge(coor.x(), coor.y(), /*coor.z(),*/dir);
}
