...
public:
    ...
    int direction;
public:
    WireSegment(int x1, int y1, int z1, int x2, int y2, int z2, int direction);
};
...
private:
    ...
    int lineDirection(int x1, int y1, int z1, int x2, int y2, int z2);
public:
    WireSegments();
    //SET Functions
    ...
    bool add_segment(int x1, int y1, int z1, int x2, int y2, int z2);
...
private:
    ...
    bool isSegmentOverflow(int x1, int y1, int z1, int x2, int y2, int z2);
    ...
    bool routeWireOnMaps(int netPos, int x, int y, int z, int length, int dir);
    ...
    bool isNeighborTileSameNet(int curX, int curY, int curZ, int netPos, int dirId);
